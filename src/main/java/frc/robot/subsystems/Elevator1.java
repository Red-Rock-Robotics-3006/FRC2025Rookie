...
public class Elevator1 extends SubsystemBase {
    private static Elevator1 instance = null;
    ...
    public static Elevator1 getInstance() {
        if (Elevator1.instance == null)
            Elevator1.instance = new Elevator1();
        return Elevator1.instance;
    }
}
